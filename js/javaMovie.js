...
let videoSrc = ['/video/Oppenheimer.mp4', '/video/thyron.mp4', '/video/theater.mp4','/video/Heart_of_Stone.mp4', '/video/extraction.mp4']
let posters = ['/images/oppenheimer-movie-poster.jpg', '/images/cloned poster.jpg', '/images/Theater poster.jpg','/images/heart-of-stone.jpg', '/images/extraction.jpg']
let imdbArray = ['⭐8.6', '⭐6.7', '⭐7.5','⭐5.7', '⭐7']
let timeLineArray = ['3h', '2h 2m', '1h 33m','2h 3m', '2h 3m']
let genreArray = ['Drama, Thriller', 'Mystery, Fantasy', 'Comedy','Mystery', 'Action, Thriller']
let movieYearArray = ['2023', '2023', '2023', '2023','2023']
let movieNameArray = ['Oppenheimer', 'They Cloned Tyrone', 'Theater Camp','Heart of Stone', 'Extraction 2']
const movieDesArray = [
